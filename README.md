...
│   ├── main.py                 BLEDeckGUI — UI, BLE lifecycle, notification dispatch
...
```bash
cd windows_app
pip install PyQt5 bleak qasync pynput
python main.py
```

> Python 3.10 or later required. Tested on Windows 10 and Windows 11.
